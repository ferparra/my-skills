...
ROUTES = [
    ...
    RouteSpec(
        route_id="excalidraw_svg_pipeline",
        keywords=[
            "generate diagram",
            "create diagram",
            "create excalidraw",
        ...
        selected_skill="obsidian-excalidraw-svg-pipeline",
        required_commands=[
            'uvx --from python python .skills/obsidian-excalidraw-svg-pipeline/scripts/classify_diagram_type.py --intent "<request>"',
            'uvx --from python python .skills/obsidian-excalidraw-svg-pipeline/scripts/validate_annotated_svg.py --path "<generated.svg>"',
            'uvx --from python python .skills/obsidian-excalidraw-svg-pipeline/scripts/svg_to_excalidraw.py --input "<generated.svg>" --output "<output.excalidraw.md>"',
        ],
    ),
    RouteSpec(
