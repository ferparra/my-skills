...
ROUTES = [
    ...
    RouteSpec(
        ...
        keywords=["weekly", "synthesis", "review", "control plane", "w10", "periodic"],
    ...
    RouteSpec(
        route_id="interweave",
        keywords=["interweave", "link", "enrich", "clipping", "wikilink", "frontmatter"],
        selected_skill="obsidian-interweave-engine",
        required_commands=[
            'obsidian read path="<note>.md"',
            'obsidian links path="<note>.md" total',
    ...
    RouteSpec(
        ...
        keywords=["memory", "insight", "friction", "pattern", "capture"],
